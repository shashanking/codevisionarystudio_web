          ...
          <div className="grid grid-cols-12 gap-x-6">
            ...
            <div className="col-span-6 pl-[8.5rem] -lg:col-span-12">
              ...
              <div className="content-box mb-12">
                <h2>Our Expertise</h2>
                <p>
                  Discover the comprehensive range of IT services we offer at
                  Code Visionary Studios. From web design and app development to
                ...
                <li>
                  <div className="rounded-[4.875rem] bg-white px-[2.875rem] py-3.5 flex items-center gap-x-5 why-us-block">
                    ...
                    <div className="content-box text-dark-400">
                      ...
                      <p>
                        We create bespoke solutions that align with your
                        specific business objectives, ensuring that every
                ...
                <li>
                  <div className="rounded-[4.875rem] bg-white px-[2.875rem] py-3.5 flex items-center gap-x-5 why-us-block">
                    ...
                    <div className="content-box text-dark-400">
                      ...
                      <p>
                        We work closely with you throughout the entire process
                        to ensure your vision is realized and expectations are
                        exceeded.
                      </p>
                    </div>
                  </div>
        ...
        <div className="container">
          ...
          <div className="text-center content-box mb-[3.75rem] px-[8%]">
            ...
            <p>
              ...
              come together to create powerful, integrated solutions that help
            ...
            <div className="col-span-6 pl-[8.5rem] -lg:col-span-12">
              ...
              <div className="content-box mb-12">
                ...
                <p>
                  ...
                  our web design, app development, branding, and digital
                  marketing services.
                </p>
              </div>
            </div>
